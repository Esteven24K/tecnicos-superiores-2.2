            ...
            <div className="container py-5">
                <div className="row g-5">
                    <div className="col-lg-7">
                        ...
                        <button
                            className="btn btn-success py-3 px-5 mt-3 wow zoomIn"
                            data-wow-delay="0.9s"
                    ...
                    <div className="col-lg-5" style={{ minHeight: "500px" }}>
                        <div className="position-relative h-100">
                            <img className="position-center w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="img/about.jpg" style={{ objectFit: "cover" }} />
                        </div>
                    </div>
                </div>
            </div>
