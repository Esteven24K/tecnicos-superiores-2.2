        ...
        <div className="container-fluid py-5 fadeInUp" data-wow-delay="0.1s">
            <div className="container py-5">
                ...
                <div className="row g-5">
                    <CardOurService service={Services[0]}/>
                    <CardOurService service={Services[1]}/>
                    <CardOurService service={Services[2]}/>
                    <CardOurService service={Services[3]}/>
                    <CardOurService service={Services[4]}/>
